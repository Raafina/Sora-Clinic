    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white ">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('doctor.checkup_schedule.index') }}"
                ...
                <li>
                    <a href="{{ route('doctor.chekingup.index') }}"
                ...
                <li>
                    <a href="{{ route('doctor.consultation.index') }}"
                ...
                <li>
                    <a href="{{ route('doctor.medicine.index') }}"
                ...
                <li>
                    <a href="{{ route('doctor.restore_medicine.index') }}"
